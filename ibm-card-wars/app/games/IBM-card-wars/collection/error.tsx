  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      <div className="max-w-md mx-auto bg-red-50 border border-red-200 rounded-lg p-8">
        ...
        <h2 className="text-2xl font-bold text-red-800 mb-2">Failed to Load Collection</h2>
        <p className="text-red-600 mb-6">Something went wrong while loading your card collection.</p>
